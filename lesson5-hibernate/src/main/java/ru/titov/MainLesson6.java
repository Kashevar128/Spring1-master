...
//
//        User user = new User("User1", Collections.emptyList(), "pass1");
...
//        entityManager.getTransaction().begin();
//        firstUserContactList.stream().forEach(contact -> contact.setUser(user));
//        secondUserContactList.stream().forEach(contact -> contact.setUser(user2));
//        user2.setId(2L);
